...
// const getBlueStandings = async (): Promise<Standings<BlueTeam>> => {
...
//
//   let problemsList = await contest.get_problems({ division: 'blue' }, ['pid', 'division', 'id', 'name'])
//
...
// }
//
// const getGoldStandings = async (): Promise<Standings<GoldTeam>> => {
