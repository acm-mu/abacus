...
def standings():
  return render_template('blue/standings.html', problems=contest.get_problems(), teams=contest.get_teams())

@blue.route('/submissions')
def submissions(): 
  return render_template('blue/submissions.html', submissions=contest.get_submissions())
...
@blue.route('/problems')
def problems():
  return render_template('blue/problems.html', problems=contest.get_problems())
...
def submit(pid):
  ...
  return render_template('blue/submit.html', problem=problem)
